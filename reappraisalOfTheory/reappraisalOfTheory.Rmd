...
subtitle: "<sub>(may contain traces of alternative facts)</sub>"
author: "Sander"
...
???
Meehl mixed blessing, awe? Paralyzing & energizing. Nowadays, hope you don’t leave the field more cluttered than when you arrived.
...
--
    ...
    - Obvious way ensure probability is low: $O_{2}$ refers to a point value, or narrow numerical interval, selected from a wide range of otherwise conceivable values. (nearly impossible in psy)
...
- Some purism/imperialism is not bad in science
- Teleology and historicity (path-dependence): *Robert Rosen* & *Ernst Mayr*
